...
public class DownModel extends AbstractTableModel{
	...
	//마우스로 유저가 클릭할때마다 id 값이 바뀌므로 아래의 메서드를 그때마다 호출하자!
	...
	public String getColumnName(int col) {
		System.out.println("getColumnName 호출"+columnName.get(col));
		return columnName.get(col);
	}

	public int getColumnCount() {
		System.out.println("getColumnCount 호출"+columnName.size());
		return columnName.size();
	}


	public int getRowCount() {
		System.out.println("getRowCount 호출"+data.size());
		return data.size();
	}
